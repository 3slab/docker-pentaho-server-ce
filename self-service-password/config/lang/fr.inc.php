...
#
#==============================================================================
include('notification_body.php');
include('reset_password_body.php');
#==============================================================================
# French
#==============================================================================
$keys = array("{title}", "{body}", "{buttonTitle}", "{footer}");
...
$messages['resetbutton'] = "Réinitialiser votre mot de passe";
$messages['preventionmessage'] = "Si vous n'êtes pas à l'origine de cette demande, merci de l'ignorer.<br/>Cordialement.";
$messages['resetsubject'] = "Réinitialisation de votre mot de passe";
$messages['restbody'] = "Bonjour {login},<br/><br/>Cliquez sur le lien ci-dessous pour réinitialiser votre mot de passe :";
$restValues   = array($messages["resetsubject"], $messages["restbody"], $messages['resetbutton'], $messages["preventionmessage"]);
$messages['resetmessage'] = str_replace($keys, $restValues, $resetPasswordTemplate);
...
$messages['changebody'] = "Bonjour {login},<br/><br/>Votre mot de passe a été changé.<br/><br/>";
$messages['changesubject'] = "Votre mot de passe a été changé";
$message['changepreventionmessage'] = "Si vous n'êtes pas à l'orgine de cette demande, contactez votre administrateur immédiatement.<br/><br/>Cordialement.";
$changeValues = array($messages["changesubject"], $messages["changebody"], '', $message["changepreventionmessage"]);
$messages['changemessage'] = str_replace($keys, $changeValues, $notificationTemplate);
...
$messages['changesshkeymessage'] = "Bonjour {login}, <br/><br/>Votre clé SSH a été changée.<br/><br/>";
$message['changesshkeypreventionmessage'] = "Si vous n'avez pas initié cette modification, contactez votre administrateur immédiatement.<br/><br/>Cordialement.";
